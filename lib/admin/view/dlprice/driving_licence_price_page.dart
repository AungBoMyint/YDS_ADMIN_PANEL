...
class DrivingLicencePricePage extends StatefulWidget {
  const DrivingLicencePricePage({super.key});

  @override
  State<DrivingLicencePricePage> createState() =>
      _DrivingLicencePricePageState();
}

class _DrivingLicencePricePageState extends State<DrivingLicencePricePage> {
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        CreateButton(
                          title: "Create Dirving Licence Price",
                          onPressed: () {
                            //TODO:CREATE ITEM
                            Get.dialog(
                              Center(
                                child: SizedBox(
                                  ...
                                  child: Material(
                                    ...
                                    child: Padding(
                                        ...
                                        child: DrivingLicencePriceAddForm()),
                                  ),
                                ),
                              ),
                              ...
                              DataCell(Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      delete<Cost>(
                                              drivingLicencePriceDocument(
                                                  item.id),
                                              "Driving Licence Price deleting is successful.",
                                              "Driving Licence Price deleting is failed.")
                                          .then((value) {
