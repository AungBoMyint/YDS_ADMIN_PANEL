...
class CarLicencePriceAddForm extends StatefulWidget {
  const CarLicencePriceAddForm({
    super.key,
    this.cost,
  });
  ...
  @override
  State<CarLicencePriceAddForm> createState() => _CarLicencePriceAddFormState();
}

class _CarLicencePriceAddFormState extends State<CarLicencePriceAddForm> {
  ...
  Widget build(BuildContext context) {
    final CarLicencePriceController glController = Get.find();
    return Form(
      key: formKey,
              ...
              onPressed: () {
                if (formKey.currentState?.validate() == true) {
                  if (widget.cost == null) {
                    ...
                    upload<Cost>(
                        carLicencePriceDocument(cost.id),
                        cost,
                        "Car Licence Price uploading is successful.",
                        "Car Licence Price uploading is failed.", () {
                      refresh();
                    ...
                    edit<Cost>(
                        carLicencePriceDocument(cost.id),
                        cost,
                        "Car Licence Price updating is successful.",
                        "Car Licence Price updating is failed.", () {
