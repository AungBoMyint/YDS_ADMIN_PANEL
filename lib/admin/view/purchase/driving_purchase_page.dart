...
class DrivingLicenceFormPurchasePage extends StatelessWidget {
  const DrivingLicenceFormPurchasePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Text("Here is your driving licence purchase list data",
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() {
                        final pft =
                            purchaseController.drivingPurchaseFilterType.value;
                        return LayoutBuilder(builder: (context, constraints) {
                          ...
                          return DropdownButtonFormField<PurchaseFilterType>(
                            ...
                            onChanged: (_) => purchaseController
                                .setDrivingPurchaseFilterType(_!),
                          );
                        });
                      }),
                    ],
        ...
        Expanded(
          child: Card(
            child: Obx(() {
              final orders =
                  purchaseController.searchDrivingLicenceForms.isNotEmpty
                      ? purchaseController.searchDrivingLicenceForms
                      : purchaseController.drivingLicenceForms;
...
void showPopupMenu(
    BuildContext context, Offset position, DrivingLicenceForm order) async {
